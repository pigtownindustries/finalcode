  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
        ...
        if (failedAttempts >= 2) {
          setTimeout(() => {
            toast.info("Butuh Bantuan?", {
              description: "Jika Anda lupa password atau mengalami kendala, silakan hubungi admin untuk bantuan.",
              duration: 8000,
            })
          }, 1000)
        }
      ...
      if (failedAttempts >= 2) {
        setTimeout(() => {
          toast.info("Butuh Bantuan?", {
            description: "Jika Anda mengalami kendala terus-menerus, silakan hubungi admin untuk bantuan.",
            duration: 8000,
          })
        }, 1000)
      }
